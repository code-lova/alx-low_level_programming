...
Project done during **Full Stack Software Engineering studies** at *Best School**. It aims to learn what are makefiles, when, why and how to use them (with variables, explicit and implicit rules).
